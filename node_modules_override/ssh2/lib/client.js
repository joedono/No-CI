...
var Socket = window.net.Socket;
var dnsLookup = window.dns.lookup;
var EventEmitter = require('events').EventEmitter;
var inherits = require('util').inherits;
var HASHES = window.crypto2.getHashes();
...
Client.prototype.connect = function(cfg) {
  ...
  if (typeof cfg.hostVerifier === 'function') {
    ...
    var hasher = crypto2.createHash(cfg.hostHash);
    ...
    switch (curAuth) {
      ...
      case 'hostbased':
        function hostbasedCb(buf, cb) {
          ...
          var signature = crypto2.createSign(algo);
...
function reqX11(chan, screen, cb) {
  ...
  var cfg = {
    ...
    cookie: crypto2.randomBytes(16).toString('hex'),
